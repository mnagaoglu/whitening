...
%     end
    ...
    subplot(3,1,1)
    s(i) = scatter(r,i + 0.025*rnd,msize,myColors{i},mySymbols{i},'filled'); 
    ...
    subplot(3,1,2)
    s2(i) = scatter(rmse,i + 0.025*rnd,msize,myColors{i},mySymbols{i},'filled'); 
    ...
    subplot(3,1,3)
    s3(i) = scatter(c,i + 0.025*rnd,msize,myColors{i},mySymbols{i},'filled'); 
